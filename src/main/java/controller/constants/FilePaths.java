...
public enum FilePaths {
    ...
    WYRM_IMAGEPATH, EPSILON_BULLET_IMAGEPATH, OMENOCT_BULLET_IMAGEPATH, NECROPICK_BULLET_IMAGEPATH, WYRM_BULLET_IMAGEPATH, BULLET_IMAGEPATH,
    ...
    public String getValue() {
        return switch (this) {
            ...
            case WYRM_IMAGEPATH -> "./src/main/resources/character sprites/wyrm.png";
            ...
            case WYRM_BULLET_IMAGEPATH -> "./src/main/resources/character sprites/wyrmBullet.png";
