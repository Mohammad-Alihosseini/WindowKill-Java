...
public enum UIMessageConstants {
    GAME_SPEED_SLIDER_NAME, VOLUME_SLIDER_NAME, EXIT_MESSAGE, EXIT_TITLE, PURCHASE_TITLE, SUCCESSFUL_PURCHASE_TITLE,
